VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} OPDailyPayments 
   Bindings        =   "OPDailyPayments.dsx":0000
   Caption         =   "OP Daily Payment Report"
   ClientHeight    =   8595
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11880
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         EndProperty
         ForeColor       =   255
         Object.Caption         =   "Out Patient Daily Payment Report"
         Alignment       =   2
      EndProperty
   EndProperty
   SectionCode2    =   3
   ...
   EndProperty
End
Attribute VB_Name = "OPDailyPayments"
