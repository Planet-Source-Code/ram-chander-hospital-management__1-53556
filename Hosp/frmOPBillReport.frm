VERSION 5.00
Begin VB.Form frmOPBillPaymentReport 
   BackColor       =   &H00C96C59&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Out  Patient Bill Report"
   ClientHeight    =   3075
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8565
   Icon            =   "frmOPBillReport.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmOPBillPaymentReport"
...
Set rs = con.Execute("Select BillId,BillNo from OPBill where PCODE =" & cmbCustName.Text)
If rs.EOF = True Then
    cmbBillNo.Clear
    rs.Close
    Exit Sub
...
Else
DataEnvironment1.OPBillPayments cmbBillNo.Text
OPBillPayments.Show
End If
End Sub
